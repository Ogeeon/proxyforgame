...
?>
	...
	<link type="text/css" href="/ogame/calc/css/graviton.css?v=<?php echo filemtime($pfgPath.'/ogame/calc/css/graviton.css'); ?>" rel="stylesheet"/>
...
<?php require_once('../../social.head.tpl'); ?>
	...
	<script type="text/javascript" src="/ogame/calc/js/graviton.js?v=<?php echo filemtime($pfgPath.'/ogame/calc/js/graviton.js'); ?>"></script>
		...
		<div>
				...
				<div id="general-settings">
					...
					<table cellpadding="2" cellspacing="0" border="0" align="center">
						<tr>
							...
							<td>
								<input id="class-collector" type="checkbox" name="class-collector" class="ui-state-default ui-corner-all ui-input"/><label for="class-collector"><?= $l['class-collector'] ?></label></td>
							<td>
				...
				<div id="tech-settings">
					<table cellpadding="2" cellspacing="0" border="0" align="center">
						<tr>
							...
							<td><input id="graviton-level" type="text" name="graviton-level" class="ui-state-default ui-corner-all ui-input energy-input ui-input-margin" value="0"/></td>
						</tr>
					</table>
				</div>
			</div>
			<div class="ui-widget-content c-ui-widget-content ui-corner-all ui-panel">
				...
				<table align="center">
					<tr>
						...
						<td>
							<label id="energy-requirement"></label>
						</td>
					</tr>
					<tr>
						<td colspan="2">
			...
			<table align="center">
				<tr>
					...
					<td>
						<div id="time-required" class="ui-state-default ui-corner-all ui-input time-show ui-input-margin">0</div>
					</td>
				</tr>
			</table>
			...
			<div class="ui-widget-content c-ui-widget-content ui-corner-all ui-panel">
			<p class="ui-state-default ui-corner-all ui-subheader"><b><?= $l['recycling'] ?></b></p>
			<table align="center">
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<div id="cargoes-for-df" class="ui-state-default ui-corner-all ui-input transport-show ui-input-margin">0</div>
					</td>
				</tr>
			</table>
		</div>
