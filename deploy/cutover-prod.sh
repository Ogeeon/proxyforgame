...
echo "  3. add the GitHub webhook at http://webhooks.proxyforgame.com/webhook.php"
echo "     http, not https - the subdomain has no certificate of its own; see deploy/README.md"
