...
echo "       LOG=$DATA/logs/deploy.log"
echo "       SYNC_CONF=$DATA/.pfg-sync.conf"
...
echo "     events: workflow_run and deployment, same secret"
echo "     (not workflow_dispatch or repository_dispatch - GitHub refuses"
echo "     both on a repository hook; see deploy/README.md)"
